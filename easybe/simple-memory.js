!(function () {
        ...
        u = {
            434: function (t, e) {
                ...
                e.Z = {
                    ...
                    handle: {
                        scroll: () => {
                            for (let t = 0; t < $.__event.scroll.handle.length; t++) $.__event.scroll.handle[t]();
                        },
                        resize: () => {
                            for (let t = 0; t < $.__event.resize.handle.length; t++) $.__event.resize.handle[t]();
            ...
            1: function (t, e, n) {
                var o = {
                    './article': [330, 148, 269],
                    './article.js': [330, 148, 269],
                    './books': [2898, 148, 463],
                    './books.js': [2898, 148, 463],
                    './common/com-article': [3515, 148],
                    './common/com-article.js': [3515, 148],
                    './home': [565, 628],
                    './home.js': [565, 628],
                    './links': [3480, 148, 583],
                    './links.js': [3480, 148, 583],
                };
                function i(t) {
                    if (!n.o(o, t))
            ...
            5299: function (t, e, n) {
                'use strict';
                async function o(t = '', e = 'GET', n = {}, o = {}) {
                    let i = { method: e, mode: 'cors', redirect: 'follow', referrerPolicy: 'no-referrer' };
                    Object.keys(o).length && (i.headers = o), Object.keys(n).length && (i.body = JSON.stringify(n));
                    return (await fetch(t, i)).json();
                }
                n.d(e, {
                    W: function () {
                        return o;
    ...
    function d(t) {
        ...
        var n = (f[t] = { exports: {} });
        return u[t](n, n.exports, d), n.exports;
    }
    (d.m = u),
                    ...
                    function (i) {
                        ...
                        var r = function () {
                            ...
                            l = new Promise(function (e) {
                                ...
                                var n = function (t) {
                                    t !== c && !f.has(t) && (f.add(t), t && !t.d && (a.r++, t.push(a)));
                                };
                                s.map(function (e) {
                                    e[t](n);
                                });
        ...
        (d.t = function (t, e) {
            ...
            var o = {};
            i = i || [null, a({}), a([]), a(a)];
            for (var r = 2 & e && t; 'object' == typeof r && !~i.indexOf(r); r = a(r))
        ...
        (d.d = function (t, e) {
            for (var n in e) d.o(e, n) && !d.o(t, n) && Object.defineProperty(t, n, { enumerable: !0, get: e[n] });
        }),
        (d.f = {}),
        (d.e = function (t) {
            return Promise.all(
                Object.keys(d.f).reduce(function (e, n) {
                    return d.f[n](t, e), e;
                }, [])
            );
        }),
        (d.u = function (t) {
            return (
                'script/' +
                {
                    ...
                    77: 'background-season',
                    86: 'circle-magic',
                    87: 'mouse-click',
                    148: 'page-common-com-article',
                    170: 'mouse-mo',
                    191: 'article-code',
                    244: 'owo-js',
                    269: 'page-article',
                    289: 'com-after',
                    290: 'background-particles',
                    297: 'gf-blink',
                    315: 'banner-images',
                    379: 'mouse-mouse',
                    463: 'page-books',
            ...
            if (r[t]) r[t].push(e);
                ...
                if (void 0 !== n)
                    for (var s = document.getElementsByTagName('script'), l = 0; l < s.length; l++) {
                        var u = s[l];
                        if (u.getAttribute('src') == t || u.getAttribute('data-webpack') == c + n) {
                            i = u;
                            break;
                        }
                    }
                ...
                if (
                    (function (t, e) {
                        ...
                        for (o = 0; o < a.length; o++) {
                            var r;
                            if ((i = (r = a[o]).getAttribute('data-href')) === t || i === e) return r;
                        }
                    })(o, i)
                )
                    return e();
        ...
        (l = { 179: 0 }),
        (d.f.miniCss = function (t, e) {
            l[t]
                ? e.push(l[t])
                : 0 !== l[t] &&
                  { 14: 1, 18: 1, 148: 1, 290: 1, 297: 1, 379: 1, 463: 1, 583: 1, 732: 1, 798: 1, 910: 1, 984: 1 }[t] &&
                  e.push(
                      (l[t] = s(t).then(
                          function () {
                              l[t] = 0;
                ...
                if (0 !== o)
                    if (o) n.push(o[2]);
                        ...
                        d.l(
                            a,
                            function (n) {
                                if (d.o(t, e) && (0 !== (o = t[e]) && (t[e] = void 0), o)) {
        ...
        (function () {
            ...
            function r(t, e) {
                const n = t.split('.'),
                    o = e.split('.');
                let i = 0;
                for (; i < n.length || i < o.length; ) {
                    let t = 0,
                        e = 0;
                    if ((i < n.length && (t = parseInt(n[i])), i < o.length && (e = parseInt(o[i])), t > e)) return 1;
                    if (t < e) return -1;
                    i++;
                }
                return 0;
            ...
            var c = {
                    ...
                    articleInfo: function (t, e) {
                        let n = 1 === e ? 'icon-marketing_fill' : 'icon-label-fill',
                            o = 1 === e ? 'article-tag-class-color' : 'article-tag-color';
                        $.each(t, (e) => {
                            let i = $(t[e]);
                            i.prepend('<span class="iconfont ' + n + '"></span>'),
                                $('#articleInfo').append(
                                    '<a href="' +
                                        i.attr('href') +
                    ...
                    tempReplacement: function (t, e, n) {
                        let o = new RegExp('##' + e + '##', 'g');
                        return t.replace(o, n);
                    },
                    batchTempReplacement: function (t, e) {
                        let n = t;
                        return (
                            $.each(e, function (t) {
                                let o = e[t],
                    ...
                    dynamicLoadingCss: function (t) {
                        $('head').append('<link>'),
                            $('head').children(':last').attr({ rel: 'stylesheet', type: 'text/css', href: t });
                    },
                    dynamicLoadingJs: function (t) {
                    ...
                    htmlFiltrationScript: function (t) {
                        let e = new RegExp('<script.*</script>', 'ig');
                        return t.replace(e, '');
                    },
                    clearIntervalTimeId: function (t) {
                        null != t && window.clearInterval(t);
                    },
                    actScroll: function (t, e) {
                        $('html,body').stop().animate({ scrollTop: t }, e);
                    },
                    getScrollPercent: function () {
                        return (($(window).scrollTop() / ($(document).height() - $(window).height())) * 100).toFixed(0);
                    },
                    ...
                    setDomHomePosition: function () {
                        $('#home').css('margin-top', $('.main-header').outerHeight() + 'px');
                    },
                    getRunDate: function (t) {
                        let e = t.split('-'),
                            n = new Date();
                        n.setUTCFullYear(e[0], e[1] - 1, e[2]), n.setUTCHours(0, 0, 0, 0);
                        let o = n,
                            i = (new Date().getTime() - o.getTime()) / 864e5,
                            a = Math.floor(i),
                            r = -24 * (a - i),
                            c = Math.floor(r),
                            s = -60 * (c - r),
                            l = Math.floor(-60 * (c - r));
                        return { daysold: a, hrsold: c, minsold: l, seconds: Math.floor(-60 * (l - s)).toString() };
                    },
                    setCookie: function (t, e, n) {
                        let o = new Date();
                        o.setTime(o.getTime() + 1e3 * n),
                            (document.cookie = t + '=' + escape(e) + '; expires=' + o.toGMTString() + '; path=/');
                    },
                    ...
                    randomString: function (t) {
                        ...
                        let e = 'ABCDEFGHJKMNPQRSTWXYZabcdefhijkmnprstwxyz2345678',
                            n = e.length,
                            o = '';
                        for (let i = 0; i < t; i++) o += e.charAt(Math.floor(Math.random() * n));
                        return o;
                    },
                    minToTime: function (t) {
                        let e = parseInt(t),
                            n = parseInt(60 * (t - e));
                        return (n = 1 === ('' + n).length ? '0' + n : n), `${e}:${n}`;
                    },
                    compareVersion: r,
                    getVersion: function () {
                        return (
                            (0, a.W)('https://api.github.com/repos/wangyang0210/easybe/releases/latest').then((t) => {
                                localStorage.setItem('version', t.tag_name),
                                    localStorage.setItem('repoUrl', t.html_url);
                            }),
                            r(localStorage.getItem('version'), $.__config.default.version)
                        );
                    },
                    setCommentBackground: function (t) {
                        'day' == t
                            ? $('textarea').css('background', $.__config.articleContent.commentBackground.options.day)
                            : $('textarea').css(
                                  'background',
                                  $.__config.articleContent.commentBackground.options.night
                              );
                    },
                    htmlReplace: function (t, e, n) {
                        $(t).html($(t).html().replace(e, n));
                    },
                },
                s = d(434);
            $(document).ready(function () {
                ($.__config = $.extend(!0, t, window?.cnblogsConfig || {})),
                    ($.__status = i),
                    ($.__tools = c),
                    ($.__timeIds = {}),
                    ($.__event = {}),
                    ...
                    $.__tools
                        ...
                        .catch((t) => console.error('moment.js', t));
            });
        })();
})();
