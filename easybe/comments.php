...
function threadedComments($comments, $options){ ?>
    ...
    <li id="li-<?php $comments->theId(); ?>">
        <div class="feedbackItem" id="<?php $comments->theId(); ?>">
            <div class="feedbackAvatar"><img src="<?php getAvatar($comments->mail) ?>"></div>
            <div class="feedbackListSubtitle <?php if ($comments->authorId && $comments->authorId == $comments->ownerId) { echo 'feedbackListSubtitle-louzhu'; } ?>">
                <div class="feedbackManage">
                    <span class="comment_actions"> <?php $comments->reply(); ?> </span>
                </div>
