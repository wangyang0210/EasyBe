    ...
    <div class="body container">
        ...
        <div class="row typecho-page-main typecho-post-area" role="form">
		    ...
		    <?php include 'custom-fields.php'; ?>
                    <p>
                        <label for="text" class="sr-only"><?php _e('文章摘要'); ?></label>
                        <textarea style="height: 40px" autocomplete="off"
                                  name="abstracts" class="w-100 mono"><?php echo htmlspecialchars($post->abstracts ?? ''); ?></textarea>
                    </p>
